...
Lucena.PesquisaRapidaCliente = (function() {
	...
	function onPesquisaConcluida(resultado) {
		...
		var tabelaClientePesquisaRapida = new Lucena.TabelaClientePesquisaRapida(this.pesquisaRapidaClientesModal);
...
Lucena.TabelaClientePesquisaRapida = (function() {
	...
	function onClienteSelecionado(evento) {
		...
		console.log(clienteSelecionado.data('id'))
...
$(function() {
	var pesquisaRapidaCliente = new Lucena.PesquisaRapidaCliente();
