...
@Configuration
@ComponentScan(basePackageClasses = Perfumes.class)
@EnableJpaRepositories(basePackageClasses = Perfumes.class, enableDefaultTransactions = false)
...
public class JPAConfig {
	...
	public DataSource dataSource() {
		...
		return dataSourceLookup.getDataSource("jdbc/perfumeiroDB");
	}
	...
	public EntityManagerFactory entityManagerFactory(DataSource dataSource, JpaVendorAdapter jpaVendorAdapter) {
		...
		factory.setPackagesToScan(Perfume.class.getPackage().getName());
